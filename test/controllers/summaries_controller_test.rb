...
class SummariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create summary" do
    assert_difference("Summary.count") do
      post summaries_url, params: { summary: { original_text: @summary.original_text, summary: @summary.summary, title: @summary.title, user_id: @summary.user_id } }
    end
  ...
  test "should update summary" do
    patch summary_url(@summary), params: { summary: { original_text: @summary.original_text, summary: @summary.summary, title: @summary.title, user_id: @summary.user_id } }
